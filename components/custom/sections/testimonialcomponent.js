                ...
                <CardBody>
                  ...
                  <div className="d-flex no-block align-items-center">
                    <span className="thumb-img">
                      <Image src={img1} alt="wrapkit" className="circle" width={80} height={80} priority/>
                    </span>
            ...
            <Col lg="4" md="6">
              <Card className="card-shadow">
                <CardBody>
                  ...
                  <div className="d-flex no-block align-items-center">
                    <span className="thumb-img">
                      <Image src={img2} alt="wrapkit" className="circle" width={80} height={80} priority/>
                    </span>
                    <div className="m-l-20">
            ...
            <Col lg="4" md="6">
              <Card className="card-shadow">
                <CardBody>
                  ...
                  <div className="d-flex no-block align-items-center">
                    <span className="thumb-img">
                      <Image src={img3} alt="wrapkit" className="circle" width={80} height={80} priority/>
                    </span>
                    <div className="m-l-20">
